...
var quotebox = document.querySelector(".quotetext");
var authorbox = document.querySelector(".quoteAuthor");
...
function changeQuote() {
      var q = quotes[random()];
        quotebox.innerHTML = q.quoteText;
        authorbox.innerHTML = q.quoteAuthor;
}



function random() {
    var i = Math.floor(Math.random() * 77);
    return i;
}
changeQuote();
